...
public class AnimatedTabHostListener implements TabHost.OnTabChangeListener
{
     ...
     * @param tabHost
     */
    public AnimatedTabHostListener(Activity context, TabHost tabHost)
    {
...
//                System.err.println(gestureDetector.onTouchEvent(event));
...
//                }
    ...
    {
        context.setTitle(tabId);

        currentView = tabHost.getCurrentView();
        System.err.println(tabHost.getCurrentTab());
