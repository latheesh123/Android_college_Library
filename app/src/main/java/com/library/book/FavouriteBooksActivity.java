...
public class FavouriteBooksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter =
                new BooksAdapter(this, 0, bookslist, 0);
        adapter.setFavouritebooks(true);
    ...
    private class GetBooksTest extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                response = remoteConnection.getJSON(Util.maptoString(map), "GetFavouriteBooksServlet");
                bookslist.clear();
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(FavouriteBooksActivity.this, "Please wait ...", "", true);
        }
