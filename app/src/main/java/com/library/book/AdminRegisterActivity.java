...
public class AdminRegisterActivity extends ParentActivity {
    ...
    public void btn_register(View view) {
        ...
        else if (token.getText().toString().trim().equals(""))
            token.setError("Please fill this");
        ...
        registration.setToken(token.getText().toString().trim());
    ...
    private class RegistrationTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            try {
                ...
                map.put("token", registration.getToken());

                response = remoteConnection.getJSON(Util.maptoString(map), "RegisterServlet");
