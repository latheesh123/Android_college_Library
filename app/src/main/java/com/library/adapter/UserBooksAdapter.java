...
public class UserBooksAdapter extends ArrayAdapter<ListByDate> {
    ...
    public UserBooksAdapter(Activity activity, int layoutResourceId, ArrayList<ListByDate> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (pojo.getStatus().equals("1")) {

            status.setText("Book Reserved");
            status.setBackgroundResource(R.color.brand_info);
        } else if (pojo.getStatus().equals("4")) {
